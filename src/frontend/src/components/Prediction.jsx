...
const ImageIdentification = () => {
    ...
    const identify = async () => {
        ...
        const results = [
            { className: 'cat', probability: 0.876 },
            { className: 'dog', probability: 0.654 },
            { className: 'bird', probability: 0.421 },
            { className: 'fish', probability: 0.189 }
        ];
        setResults(results)
    }
    ...
    return (
        <div className="App">
            ...
            <h1>My App</h1>
            <button onClick={handlePredictions}>Fetch Predictions</button>
           </div>
